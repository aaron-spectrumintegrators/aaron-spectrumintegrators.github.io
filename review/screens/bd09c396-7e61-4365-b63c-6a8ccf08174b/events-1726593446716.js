jQuery("#simulation")
  .on("click", ".s-bd09c396-7e61-4365-b63c-6a8ccf08174b .click", function(event, data) {
  ...
  .on("click", ".s-bd09c396-7e61-4365-b63c-6a8ccf08174b .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "target": [ "#s-bd09c396-7e61-4365-b63c-6a8ccf08174b #s-Button_2 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-bd09c396-7e61-4365-b63c-6a8ccf08174b #s-Button_2 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                ...
                "actions": [
                  {
                    "action": "jimChangeStyle",
                    "parameter": [ {
                      "target": [ "#s-bd09c396-7e61-4365-b63c-6a8ccf08174b #s-Button_4 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-bd09c396-7e61-4365-b63c-6a8ccf08174b #s-Button_4 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                        "background-repeat": "no-repeat",
                        "background-attachment": "scroll",
                        "background-size": "auto",
  ...
  .on("mouseenter dragenter", ".s-bd09c396-7e61-4365-b63c-6a8ccf08174b .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-bd09c396-7e61-4365-b63c-6a8ccf08174b .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("variablechange.jim", ".s-bd09c396-7e61-4365-b63c-6a8ccf08174b .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
