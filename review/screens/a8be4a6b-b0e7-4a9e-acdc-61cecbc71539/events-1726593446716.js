jQuery("#simulation")
  .on("click", ".s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 .click", function(event, data) {
  ...
  .on("click", ".s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "target": [ "#s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 #s-Button_2 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 #s-Button_2 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                ...
                "actions": [
                  {
                    "action": "jimChangeStyle",
                    "parameter": [ {
                      "target": [ "#s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 #s-Button_4 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 #s-Button_4 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                        "background-repeat": "no-repeat",
                        "background-attachment": "scroll",
                        "background-size": "auto",
  ...
  .on("mouseenter dragenter", ".s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("variablechange.jim", ".s-a8be4a6b-b0e7-4a9e-acdc-61cecbc71539 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
