jQuery("#simulation")
  .on("click", ".s-68f96f1c-3d0d-4b10-9757-c932f37232c6 .click", function(event, data) {
  ...
  .on("click", ".s-68f96f1c-3d0d-4b10-9757-c932f37232c6 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "target": [ "#s-68f96f1c-3d0d-4b10-9757-c932f37232c6 #s-Button_2 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-68f96f1c-3d0d-4b10-9757-c932f37232c6 #s-Button_2 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                ...
                "actions": [
                  {
                    "action": "jimChangeStyle",
                    "parameter": [ {
                      "target": [ "#s-68f96f1c-3d0d-4b10-9757-c932f37232c6 #s-Button_4 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-68f96f1c-3d0d-4b10-9757-c932f37232c6 #s-Button_4 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                        "background-repeat": "no-repeat",
                        "background-attachment": "scroll",
                        "background-size": "auto",
  ...
  .on("mouseenter dragenter", ".s-68f96f1c-3d0d-4b10-9757-c932f37232c6 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-68f96f1c-3d0d-4b10-9757-c932f37232c6 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("variablechange.jim", ".s-68f96f1c-3d0d-4b10-9757-c932f37232c6 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
