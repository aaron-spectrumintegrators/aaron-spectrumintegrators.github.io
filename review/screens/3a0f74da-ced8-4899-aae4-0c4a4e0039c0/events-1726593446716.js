jQuery("#simulation")
  .on("click", ".s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 .click", function(event, data) {
  ...
  .on("click", ".s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "target": [ "#s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 #s-Button_2 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 #s-Button_2 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                ...
                "actions": [
                  {
                    "action": "jimChangeStyle",
                    "parameter": [ {
                      "target": [ "#s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 #s-Button_4 > .backgroundLayer > .colorLayer" ],
                      "attributes": {
                        "background-color": "#D33C3C"
                      }
                    },{
                      "target": [ "#s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 #s-Button_4 > .backgroundLayer > .imageLayer" ],
                      "attributes": {
                        "background-repeat": "no-repeat",
                        "background-attachment": "scroll",
                        "background-size": "auto",
  ...
  .on("mouseenter dragenter", ".s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("variablechange.jim", ".s-3a0f74da-ced8-4899-aae4-0c4a4e0039c0 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
